...
app.use(
  session({
    // o identificador da sessão (ID) fica em um cookie no navegador, mas os dados da sessão ficam no servidor (MemoryStore). O cookie só guarda o ID, não os dados completos.
    secret: "my-secret",
    resave: false,
