...
export function makeLoginUrl() {
  ...
  const loginUrlParams = new URLSearchParams({
    ...
    // Sim, no Implicit Flow você deve usar response_type: "token id_token" para receber ambos access token e id token diretamente na resposta. Isso diferencia do Authorization Code Flow, que usa response_type: "code".
